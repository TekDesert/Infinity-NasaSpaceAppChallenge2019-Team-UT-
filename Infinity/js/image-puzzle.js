...
function renew(){
    var images = [
                ...
                { src: 'images/Earth_Moon.jpg', title: 'Early Earth and Theia Collison' },
                { src: 'images/earth.jpg', title: 'Earth' },
                { src: 'images/sun.jpg', title: 'Sun' },
                { src: 'images/bb.jpg', title: 'Big Bang' }
            ];var gridSize = $('#levelPanel :radio:checked').val();
                 return imagePuzzle.startGame(images, gridSize);
}